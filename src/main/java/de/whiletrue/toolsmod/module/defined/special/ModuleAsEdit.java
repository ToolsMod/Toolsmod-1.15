...
import de.whiletrue.toolsmod.module.defined.special.asedit.gui.defined.*;
...
public class ModuleAsEdit extends Module {
	...
	public final GuiGroup<GuiAsEdit> guis = GuiGroup.of(new GuiAsEditSettings(), new GuiAsEditAdjust(),
