package de.whiletrue.toolsmod.module.defined.player.ghostsight;
...
public class GhostPlayer {
    ...
    public void create() {
    	...
    	GameProfile p = new GameProfile(UUID.randomUUID(), String.format("§8[§%cGhostsight§8] §%c%s",Toolsmod.COLOR_MAIN,Toolsmod.COLOR_SECONDARY,this.mc.player.getName().getFormattedText()));
        ...
        this.ghost.onGround=this.mc.player.onGround;
    ...
    public void destroy(boolean tpBack) {
        ...
        if(tpBack){
            ...
            this.mc.player.onGround=this.ghost.onGround;
            //Sets the velocity
