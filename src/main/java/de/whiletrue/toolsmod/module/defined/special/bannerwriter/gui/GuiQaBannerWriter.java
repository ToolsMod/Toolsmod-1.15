package de.whiletrue.toolsmod.module.defined.special.bannerwriter.gui;
...
public class GuiQaBannerWriter extends GuiQuickAccess {
	...
	public void render(int mouseX, int mouseY, float p_render_3_) {
		...
		this.drawCenteredString(this.font, this.letterName, this.width / 2 + 25, this.height / 2 - 14,
				this.letterColor.getColor());

		// Renders the selected background color
		this.drawCenteredString(this.font, this.backgroundName, this.width / 2 + 25, this.height / 2 + 26,
