...
import de.whiletrue.toolsmod.module.defined.special.headwriter.gui.GuiQaHeadWriterText;
import de.whiletrue.toolsmod.module.defined.special.headwriter.gui.GuiQaHeadWriterType;
        ...
        for(char c:text.toCharArray()){
            ...
            CompoundNBT nbt = new CompoundNBT(){{
               CompoundNBT skullOwner = new CompoundNBT(){{
                   this.putString("Id", UUID.randomUUID().toString());
