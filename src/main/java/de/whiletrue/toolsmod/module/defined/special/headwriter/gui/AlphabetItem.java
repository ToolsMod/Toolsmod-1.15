package de.whiletrue.toolsmod.module.defined.special.headwriter.gui;
...
public class AlphabetItem extends MultirowListItem<Alphabet>{
	...
	public void render(int mX, int mY, float ticks, TmWidget focused) {
		...
		RENDERER.renderRect(this.x, this.y, this.width, this.height, hovered||this.select?0xff008FFF:0xffee5a24);
		
		//Renders the name
		RENDERER.renderCenteredString(this.item.getName(), this.x+this.width/2, this.y+this.height/2-4, 0xFFffffff);
	}
