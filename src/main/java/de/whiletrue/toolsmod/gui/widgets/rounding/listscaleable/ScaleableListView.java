...
//		this.renderer.stopScissor();
		...
		if (this.listHeight > this.height && !this.slider.equals(EnumListSlider.NONE)) {
			...
			this.renderer.renderRect(sX, this.y, this.sliderWidth, this.height, 0xff000000);

			// Renders the slider outline
			this.renderer.renderRect(sX, sY, this.sliderWidth, this.sliderHeight, 0xFF808080);
			// Renders the slider background
			this.renderer.renderRect(sX, sY, this.sliderWidth - 1, this.sliderHeight - 1, 0xFFc0c0c0);
		}
	}
