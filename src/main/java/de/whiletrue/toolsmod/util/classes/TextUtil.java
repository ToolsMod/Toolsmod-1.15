...
public class TextUtil {
    ...
    public String getByKey(String key){
    	return LanguageMap.getInstance().translateKey(Toolsmod.ID+"."+key);
    }
    ...
    public TextComponent appendColors(String text){
        ...
        for(String s:split){
            ...
            TextFormatting color = current.getStyle().getColor();
            ...
            if(!tf.isColor())
                ...
                current.applyTextStyle(color);
            //Sets the new color
            current.applyTextStyle(tf);
